...
- **Definition:** A **WEC User** is an Affiliate User whose **total MyCash income** (sum of all MyCash Program rewards) in the **last 60 days** **has reached $10,000**. WEC status is **temporary and automatic** once the threshold is met.
