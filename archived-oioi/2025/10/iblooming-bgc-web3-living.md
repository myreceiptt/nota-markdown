...
| **Legal & Compliance Mapping** | Define legal path for public/licensed token launch. | TBD 🧭 | TBD | Legal Advisor, Prof. NOTA, External Consultants | Determines eligibility for market release or partnerships. |
...
Once the pillars are stabilized:
- Create GitHub repos (frontend/backend/contracts)
- Map milestone roadmaps (v0.1, v0.2, etc.)
- Assign tasks across Tech, Ops, Legal, and Creative
- Keep strategy grounded in behavioral truth, not hype
...
| **1** | Draft **Tokenomics & WhitePaper** (iBC/iBTC) using ALPHA Coin behavior data.                                  | [`iBLOOMING-Coin-WhitePaper-Draft.md`](../../../active-oioi/2025/09/bgc-iblooming-draft-whitepaper.md)                                                                                 | 🛠 In Progress | Ongoing drafting based on extracted BGC data.                                                      |
| **2** | Map **Token Flow** across iBLOOMING & BGC systems.                                                            | [`Token-Flow-Map.md`](../../../active-oioi/2025/09/token-flow-map.md)                                                                                                  | 🛠 In Progress | Requires coordination with both Ops and Dev teams for accuracy.                                    |
...
| **4** | Assign responsible persons, owners, and execution timelines for each pillar & sub-pillar.                     | `Pillar-Owner-Assignment.md`                                                                                         | 🧪 Planned     | Dependent on completion of steps 1–3 to ensure accurate role allocation.                           |
| **5** | Prepare **Phase 1 Implementation Plan** (technical, operational, legal readiness).                            | `Phase1-Implementation-Checklist.md`                                                                                 | 🧪 Planned     | Will only begin after initial tokenomics & token flow validation.                                  |
...
- Est. Duration matches **Execution Matrix** (Section 5) for consistency.
